...
if (students1.indexOf(toRemove) !== -1) {
    let posToRemove1 = students1.indexOf(toRemove)

    students1.splice(posToRemove1, 1)
}

console.log(students1)

if (students2.indexOf(toRemove) !== -1) {
    let posToRemove2 = students2.indexOf(toRemove)

    students2.splice(posToRemove2, 1)
}
...
if (numberOfStudents === 1) {
    ...
    (numberOfStudents >= 2 && numberOfStudents <= 5) {
