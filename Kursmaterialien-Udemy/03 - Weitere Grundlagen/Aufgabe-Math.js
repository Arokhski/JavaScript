...
let amountStr = "15,37"
let amount = amountStr.replace(",", ".") * 100
console.log(" - " + Math.floor(amount / 200) + "x 2€")
amount = amount - Math.floor(amount / 200) * 200 //die variable amount wird aktualisiert

console.log(" - " + Math.floor(amount / 100) + "x 1€")
amount = amount - Math.floor(amount / 100) * 100

console.log(" - " + Math.floor(amount / 50) + "x 50ct")
amount = amount - Math.floor(amount / 50) * 50

console.log(" - " + Math.floor(amount / 20) + "x 20ct")
amount = amount - Math.floor(amount / 20) * 20

console.log(" - " + Math.floor(amount / 10) + "x 10ct")
amount = amount - Math.floor(amount / 10) * 10

console.log(" - " + Math.floor(amount / 5) + "x 5ct")
amount = amount - Math.floor(amount / 5) * 5

console.log(" - " + Math.floor(amount / 2) + "x 2ct")
amount = amount - Math.floor(amount / 2) * 2

console.log(" - " + Math.floor(amount / 1) + "x 1ct")
...
let tip2 = bill2 * 0.15
let tip3 = bill3 * 0.15
console.log("Der Rechnungsbetrag ist " + bill1 + "$ plus Trinkgeld in Höhe von " + tip1.toFixed(2) + "$, was gerundet einen Gesamtbetrag von " + Math.ceil(tip1 + bill1) + "$ macht.")
console.log("Der Rechnungsbetrag ist " + bill2 + "$ plus Trinkgeld in Höhe von " + tip2.toFixed(2) + "$, was gerundet einen Gesamtbetrag von " + Math.ceil(tip2 + bill2) + "$ macht.")
console.log("Der Rechnungsbetrag ist " + bill3 + "$ plus Trinkgeld in Höhe von " + tip3.toFixed(2) + "$, was gerundet einen Gesamtbetrag von " + Math.ceil(tip3 + bill3) + "$ macht.")